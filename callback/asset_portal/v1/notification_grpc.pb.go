...
const (
	NotificationService_Create_FullMethodName = "/asset_portal.v1.NotificationService/Create"
)
...
func (UnimplementedNotificationServiceServer) Create(context.Context, *Notification) (*emptypb.Empty, error) {
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "asset_portal.v1.NotificationService",
